...
#          Name boxes so that they will appear at appropriate time for cage_set
#
#------------------------------------------------------------------------------#
...
def parse_data(num_part=0):
    ...
    for i in range(0, len(array)):
        new_sphere_MC(0.01, array[i][0], array[i][1], array[i][2], 
                      array[i][0], array[i][1], array[i][2], i)
...
# goes through all the data! Woo!
# Written (in part) by Kramsfasel
def parse_octree_data(num_part=0):
    array = []
